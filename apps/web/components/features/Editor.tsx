...
export const Editor = () => {
    ...
    return (
        <div className="absolute top-0 right-0 h-full w-80 bg-white/95 dark:bg-zinc-900/95 backdrop-blur shadow-xl p-6 overflow-y-auto border-l border-zinc-200 dark:border-zinc-800 z-10 text-zinc-900 dark:text-zinc-100">
            <h1 className="text-xl font-bold mb-6">Dart Configurator</h1>
